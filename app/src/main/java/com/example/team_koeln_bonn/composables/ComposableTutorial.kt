...
fun TutorialMessageCard(msg : TutorialMessage){
    Team_Koeln_BonnTheme{
        Column{
            Text("Message Display:" , color = MaterialTheme.colorScheme.primary, style = MaterialTheme.typography.titleMedium)
...
fun TutorialPreviewMessageCard(){
    Team_Koeln_BonnTheme() {
        Surface() {
            TutorialMessageCard(TutorialMessage("Authot", "Message"))
        }
    }
}
